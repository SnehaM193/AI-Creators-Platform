...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      {/* Hero Section */}
    <section className="relative z-10 mt-30 px-4 sm:px-6">
        ...
        <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
          <div className="space-y-4 sm:space-y-6">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 font-light leading-relaxed max-w-2xl md:max-w-none">The AI-powered platform that turns your ideas into 
              <span className="text-purple-300 font-semi-bold">
                {" "}
                engaging content
              </span>{" "}
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-8 justify-center lg:justify-start">
            <Link href="/dashboard">
              <Button
                size="xl"
                variant="primary"
                className="rounded-full px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-purple-500 via-blue-500 to-green-400 hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-purple-500/30"
              >
            ...
            <Link href="/feed">
              <Button
                size="xl"
                variant="outline"
                className="rounded-full px-8 py-4 text-lg font-semibold border-2 border-purple-400 text-purple-300 hover:bg-purple-400 hover:text-white hover:scale-105 transition-all duration-300 shadow-md hover:shadow-purple-500/30"
              >
                Explore the Feed
                <ArrowRight className="h-4 w-4 ml-2" />
              </Button>
